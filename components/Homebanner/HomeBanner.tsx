  ...
  return (
    <div className="flex flex-col items-center justify-center gap-10">
      <div className="w-full">
        <h1 className="text-4xl md:text-5xl font-bold text-blue-primary text-center lg:text-left">
          SINE
          <span className="text-green-primary">-</span>
          <span className="relative inline-block">
            EXERCISE
            <span className="absolute -bottom-2 left-0 w-full h-1 bg-green-primary"></span>
          </span>
        </h1>
        <p className="lg:pr-20 mt-10 text-center lg:text-left text-gray-400 text-2xl">
